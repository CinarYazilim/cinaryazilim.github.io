                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ml-auto">
                            ...
                            <li className="nav-item"><a className="nav-link" href="#top">PROJELER</a></li>
                            <li className="nav-item"><a className="nav-link" href="#top">HAKKIMIZDA</a></li>
                            <li className="nav-item"><a className="nav-link" href="#top">İLETİŞİM</a></li>
